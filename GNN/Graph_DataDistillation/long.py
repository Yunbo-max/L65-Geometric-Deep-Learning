# -*- coding: utf-8 -*-
# @Author: Yunbo
# @Date:   2024-04-21 18:09:50
# @Last Modified by:   Yunbo
# @Last Modified time: 2024-04-21 18:25:07
import numpy as np
import torch
...
from models.manifold import yunbo
...
class SGDD:
    ...
    def __init__(self, data, args, device='cuda', **kwargs):
        ...
        self.yunbo = yunbo(nfeat=d, nnodes=n, device=device,args=args).to(device)

        self.labels_syn = torch.LongTensor(self.generate_labels_syn(data)).to(device)

        self.reset_parameters()
        self.optimizer_feat = torch.optim.Adam([self.feat_syn], lr=args.lr_feat)
        self.optimizer_pge = torch.optim.Adam(self.yunbo.parameters(), lr=args.lr_adj)
